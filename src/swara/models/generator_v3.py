"""Swara Generator v3: scheduled text/control plus full-frame causal Talker.
...
class SwaraSpeechGeneratorV3:
    ...
    def __init__(self, config: GeneratorV3Config, vocabulary: LinguisticVocabulary, speaker_ids: tuple[str, ...]):
        ...
        self.module = _V3Module(config, nn, kinds, languages, kind_count, language_count)
        ...
        class Module(nn.Module):
            ...
            def frame_inputs(self, text, frames, schedule_frames=None):
                ...
                for t in range(n):
                    ...
                    states.append(acoustic + trailing[:, t:t+1] + self.audio_pos.weight[min(t, config.max_audio_frames-1)].view(1,1,-1) + self.modality.weight[1])
