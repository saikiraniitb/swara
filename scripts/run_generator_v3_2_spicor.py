...
def main():
    ...
    ap.add_argument("--run", type=Path, default=Path("runs/generator_v3_2_spicor_30min_v0"))
    ...
    if args.evaluate_only:
        ...
        model = SwaraSpeechGeneratorV32(config, vocab, (SPEAKER,)); model.module.to(device)
